...
class ExamplePanel(wx.Panel):
    def __init__(self, parent):
        ...
        # A multiline TextCtrl - This is here to show how the events work int his program, don't pay too much
        # attention to it
        ...
        rb = wx.RadioBox(self, label="What color would you like ?", pos=(20, 210), choices=radio_list, majorDimension=3,
