...
class Game():
    ...
    def __init__(self, player, alien_group, player_bullet_group, alien_bullet_group):
        ...
        self.new_round_sound = pygame.mixer.Sound(f"space_invaders_assets\\new_round.wav")
        self.new_round_sound.set_volume(0.2)
        self.breach_sound = pygame.mixer.Sound(f"space_invaders_assets\\breach.wav")
        self.breach_sound.set_volume(0.2)
        self.alien_hit_sound = pygame.mixer.Sound(f"space_invaders_assets\\alien_hit.wav")
        self.alien_hit_sound.set_volume(0.2)
        self.player_hit_sound = pygame.mixer.Sound(f"space_invaders_assets\\player_hit.wav")
        self.player_hit_sound.set_volume(0.2)

        # Set font
        self.font = pygame.font.Font(f"space_invaders_assets\\Facon.ttf", 32)
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load(f"space_invaders_assets\\player_ship.png")
        ...
        self.shoot_sound = pygame.mixer.Sound(f"space_invaders_assets\\player_fire.wav")
...
class Alien(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, velocity, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load(f"space_invaders_assets\\alien.png")
        self.rect = self.image.get_rect()
        ...
        self.shoot_sound = pygame.mixer.Sound(f"space_invaders_assets\\alien_fire.wav")
        self.shoot_sound.set_volume(0.2)
...
class PlayerBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, bullet_group):
        ...
        super().__init__()
        self.image = pygame.image.load(f"space_invaders_assets\\green_laser.png")
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.centery = y
...
class AlienBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, bullet_group):
        """Initialize the bullet"""
        super().__init__()
        self.image = pygame.image.load(f"space_invaders_assets\\red_laser.png")
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.centery = y
...
# Create a player goup and player object
