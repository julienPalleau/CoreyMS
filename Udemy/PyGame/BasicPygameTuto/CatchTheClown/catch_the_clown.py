...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if clown_rect.collidepoint(mouse_x, mouse_y):
                ...
                while previous_dx == clown_dx and previous_dy == clown_dy:  # To avoid getting the clown going in the same direction twice.
                    clown_dx = random.choice([-1, 1])
                    clown_dy = random.choice([-1, 1])
    ...
    # Bounce the clow off the edges of the display
