...
class Game:
    ...
    def choose_new_target(self):
        ...
        self.target_monster_type = target_monster.type  # with this line monster color doesn't match color box anymore
...
while running:
    ...
    my_game.update()
    my_game.draw()  # here it is not the method draw that comes from Sprite but method draw from Game so no need display_surface
